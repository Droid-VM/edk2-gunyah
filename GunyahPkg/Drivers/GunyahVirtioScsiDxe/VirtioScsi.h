...
#define VIRTIO_SCSI_EVENT_QUEUE    1
...
typedef struct {
  ...
  VRING                              ControlRing;    // VirtioScsiInit      1
  VOID                               *ControlRingMap;// VirtioScsiInit      1
  VRING                              EventRing;      // VirtioScsiInit      1
  VOID                               *EventRingMap;  // VirtioScsiInit      1
