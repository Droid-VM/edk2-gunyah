  ...
  )
{
  ...
  //
  // Find all VirtIO input class PCI devices and connect them non-recursively.
  // This should produce SimpleTextIn on them via VirtioKeyboardDxe.
  //
  ...
  //
  // Add the device path of all connected VirtIO input devices to ConIn.
  //
  FilterAndProcess (&gEfiPciIoProtocolGuid, IsVirtioPciInput, AddInput);
