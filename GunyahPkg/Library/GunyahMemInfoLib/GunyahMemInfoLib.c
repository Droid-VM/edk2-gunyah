  ...
  )
{
  ...
  Hob  = BuildGuidDataHob (&gGunyahSystemMemorySizeGuid, &Size, sizeof Size);
  ASSERT (Hob != NULL);
  ...
  )
{
  ...
  MemorySizeHob = GetFirstGuidHob (&gGunyahSystemMemorySizeGuid);
